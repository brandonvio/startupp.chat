...
def test_file_naming_consistency():
    ...
    try:
        ...
        assert video_base == transcript_base, "Video and transcript files should have the same base name"
...
def main():
    ...
    if passed == total:
        logger.success("🎉 All naming tests passed! Video ID-based naming is working correctly.")
        return 0
    else:
