...
def test_youtube_facets():
    ...
    try:
        ...
        youtube_url = "https://www.youtube.com/watch?v=O5xeyoRL95U"  # MIT deep learning video
        post_text = f"Testing YouTube facets! Check out this MIT deep learning masterclass: {youtube_url} #AI #MachineLearning #MIT"
        
        logger.info(f"Testing YouTube facet post...")
        ...
        if success:
            ...
            logger.info("Check your Bluesky feed - the YouTube link should show a rich preview!")
            return True
        else:
